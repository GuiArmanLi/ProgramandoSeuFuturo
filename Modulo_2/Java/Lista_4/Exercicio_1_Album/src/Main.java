public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("A musica com maior popularidade é: " + playGay.getMusicaMaiorPopularidade().getNome());

        System.out.println("A musica com menor duracao é: " + playGay.getMusicaMenorDuracao().getDuracaoEmSegundos());
    }
}